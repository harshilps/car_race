...
void main()
 ...
 int x=300,y=350,ch,life=3,score=0,m,n,i,level,x1,y1,x2,y2;
 char choice;
 int accident;
 initgraph(&gdriver,&gmode,"C:\\Turboc3\\BGI");
  ...
  printf("Created By:");
  gotoxy(5,22);
  printf("Kapadia Darshil");
  gotoxy(5,23);
  printf("Shah Meet");
  gotoxy(5,24);
  printf("Shah Ruchir");
  gotoxy(5,25);
  printf("Rathod Praful");
    ...
    while(y1<getmaxy()-1)
    {
      ...
      if(accident==1){
        ...
        if(life==0) {
         ...
         printf("GAME OVER ");
         gotoxy(5,6);
         printf("You could not save");
         gotoxy(5,7);
         printf("her");
         break;
         }
        gotoxy(5,5);
        printf("You have lost 1 life");
        delay(500);
        gotoxy(5,5);
        printf("                    ");
        }
